        ...
        >
            <Section>
                <div className="mx-auto max-w-2xl py-24 text-center">
                    ...
                    <h1 className="mb-4 text-4xl font-bold text-[#0b2a3d]">
                        Merci pour votre générosité&nbsp;
                        <Heart className="inline h-8 w-8 text-[#055288]" />
                    </h1>

                    <p className="mb-4 text-xl leading-relaxed text-[#4a6a7d]">
                    ...
                    <p className="mb-10 text-base text-[#4a6a7d]">
